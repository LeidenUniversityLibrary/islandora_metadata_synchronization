<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:oai="http://www.openarchives.org/OAI/2.0/" exclude-result-prefixes="xlink marc oai" version="1.0">
...
Revision 1.02 - Added Log Comment  2003/03/24 19:37:42  ckeith
	...
	<xsl:template match="/">
		<xsl:choose>
			<xsl:when test="//oai:GetRecord/oai:record/oai:header[@status='deleted']">
				<xsl:message terminate="yes">Record was deleted!</xsl:message>
			</xsl:when>
...
-->
		...
		<!-- Reintroduce tag 787 for relateditem mapping -->
		<xsl:for-each select="marc:datafield[@tag=765]|marc:datafield[@tag=767]|marc:datafield[@tag=775]|marc:datafield[@tag=787]">
